...
const config = {
    ...
    WEBHOOK_URL: process.env.WEBHOOK_URL || 'http://localhost:3002/webhook',
    WEBHOOK_PORT: parseInt(process.env.WEBHOOK_PORT) || 3002,
    WEBHOOK_SECRET: process.env.WEBHOOK_SECRET || 'zapbot-webhook-secret-2024',

    // --- Solana Network ---
    RPC_URL: process.env.RPC_URL || 'https://gilligan-jn1ghl-fast-mainnet.helius-rpc.com',
    WS_URL: process.env.WS_URL || 'wss://atlas-mainnet.helius-rpc.com/?api-key=b9a69ad0-d823-429e-8c18-7cbea0e31769',
    LASERSTREAM_ENDPOINT: process.env.LASERSTREAM_ENDPOINT || 'wss://atlas-mainnet.helius-rpc.com/?api-key=b9a69ad0-d823-429e-8c18-7cbea0e31769',
    ...
    SINGAPORE_ENDPOINTS: {
        ...
        laserstream: process.env.SGP_LASERSTREAM_URL || 'wss://atlas-mainnet.helius-rpc.com/?api-key=b9a69ad0-d823-429e-8c18-7cbea0e31769',
        websocket: process.env.SGP_WS_URL || 'wss://atlas-mainnet.helius-rpc.com/?api-key=b9a69ad0-d823-429e-8c18-7cbea0e31769'
    },
...
LASERSTREAM_ENDPOINT: process.env.LASERSTREAM_ENDPOINT || 'https://laserstream-mainnet-sgp.helius-rpc.com',
    ...
    PERFORMANCE_THRESHOLDS: {
        ...
        slippageTolerance: 9000,      // Slippage tolerance in basis points (90%) - Required for pump.fun volatility
